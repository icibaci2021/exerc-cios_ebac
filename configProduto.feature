...
Esquema do Cenário: Escolher quantidades do produto
Quando eu clicar no <produto> desejado
E escolher <quantidade> do produto
E clicar no botão "Comprar"
Então deve apresentar <mensagem>

Exemplos: 
|produto|quantidade|mensagem|
|blusa|10|"adicionado com sucesso"|
|blusa|11|"quantidade máxima excedida por item"|
